...
2. Open [`public/amazon-prime-subtitle-downloader.user.js`](public/amazon-prime-subtitle-downloader.user.js) and click **Raw** — your userscript manager will prompt to install.
